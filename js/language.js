...
const translations = {
    es: {
        ...
        'exp1-company': 'Global Crew (Estados Unidos)',
        'exp1-position': 'Desarrollador Backend Jr.',
        'exp1-description': 'Junto al equipo de Backend, desarrollamos y mantenemos la capa de servidor de aplicaciones web utilizando Express.js y MongoDB. Modelamos datos, exponemos APIs seguras, documentamos los endpoints y optimizamos consultas para asegurar una experiencia ágil y confiable tanto para usuarios finales como para el equipo de Frontend.',
        'exp2-date': '2024 - 2025',
        ...
        'project2-description': 'Aplicación web realizada en .NET (ASP.NET y C#) que permite mostrar el catálogo de artículos, filtrar la búsqueda, crear un usuario, agregar artículos a favoritos y administrar los artículos/usuarios.',
    ...
    en: {
        ...
        'exp1-company': 'Global Crew (United States)',
        'exp1-position': 'Jr. Backend Developer',
        'exp1-description': 'Together with the Backend team, we develop and maintain the server layer of web applications using Express.js and MongoDB. We model data, expose secure APIs, document endpoints, and optimize queries to ensure a fast and reliable experience for both end users and the Frontend team.',
        'exp2-date': '2024 - 2025',
        'exp2-company': 'Freelance (Argentina)',
        ...
        'project2-description': 'Web application made in .NET (ASP.NET y C#) that allows showing the articles catalog, filtering search, creating a user, adding articles to favorites and managing articles/users.',
        'project3-title': 'Portfolio',
